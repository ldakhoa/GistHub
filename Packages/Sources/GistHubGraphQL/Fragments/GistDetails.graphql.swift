...
public struct GistDetails: GistHubGraphQL.SelectionSet, Fragment {
  public static var fragmentDefinition: StaticString {
    "fragment GistDetails on Gist { __typename id name description files { __typename name language { __typename name } size text } createdAt owner { __typename id login avatarUrl ... on User { name twitterUsername isSiteAdmin url bio email } } updatedAt comments { __typename totalCount } isPublic url stargazerCount forks { __typename totalCount } }"
  }
  ...
  public struct Owner: GistHubGraphQL.SelectionSet {
    ...
    public struct AsUser: GistHubGraphQL.InlineFragment {
      ...
      public typealias RootEntityType = GistDetails.Owner
  ...
  public struct Forks: GistHubGraphQL.SelectionSet {
    public let __data: DataDict
    public init(_dataDict: DataDict) { __data = _dataDict }
