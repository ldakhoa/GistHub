...
public class FollowingsQuery: GraphQLQuery {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query Followings($login: String!, $first: Int, $after: String) { user(login: $login) { __typename following(first: $first, after: $after) { __typename nodes { __typename ...UserDetail } } } }"#,
